 ...
 * MemoryUsage.java
 *
 * Created on October 5, 2005, 10:49 AM
 */

package ca.umontreal.iro.banality;

/**
 * [Memory usage testing class: stolen from somewhere.]
 *
 * @author  csuros
 */
public class MemoryUsage {
    ...
    public static void main (String [] args) throws Exception
    {
        ...
        for (int i = -1; i < count; ++ i)
        {
            ...
            //object = new java.util.BitSet(8192); // 32 bytes
            //object = new byte [32][1]; // 656 bytes?!
            //object = new short[2000];
            //object = new BitArray(1<<30); // 1056=1024+32 bytes
            object = new long[1]; 
    ...
    private static void _runGC () throws Exception
    {
        ...
        for (int i = 0; (usedMem1 < usedMem2) && (i < 1000); ++ i)
        {
            ...
            usedMem2 = usedMem1;
            usedMem1 = usedMemory ();
            //System.out.println("#** i="+i+" um1="+usedMem1+" um2="+usedMem2);
        }
    }
    ...
    private static void reportMemory(String occasion){
        System.gc();
        System.out.println(Runtime.getRuntime().freeMemory());
        Runtime RT=Runtime.getRuntime();
        long tM=RT.totalMemory();
        long uM=tM-RT.freeMemory();
        double uMMeg = ((int) (0.5+uM/(102.4*1024.)))/10.;
        double tMMeg = ((int) (0.5+tM/(102.4*1024.)))/10.; 
        
        System.out.println("#**main memory "+occasion+" used "+uM+" ["+uMMeg+"M] footprint "+tM+" ["+tMMeg+"M]");
    }
